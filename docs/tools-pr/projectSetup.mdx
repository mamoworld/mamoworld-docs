...
### Customization: Project Folder Input
...
<Youtube id="xYLs4SRxdLU" />

You find the modified block script in our [Community Library](../intro.mdx#join-the-community) at<br/>
`Project Management/Create and Import/New Project from Template Folder with Target Folder Input.xml`<br/>
Here is the direct download link to the file:

<RoundButton url="https://www.dropbox.com/scl/fi/tn7lbprgm9a9fpmo16hlj/New-Project-from-Template-Folder-with-Target-Folder-Input.xml?rlkey=pvzexnhzitcwmove3igplzi7x&dl=1" label="Download Blockscript" />
