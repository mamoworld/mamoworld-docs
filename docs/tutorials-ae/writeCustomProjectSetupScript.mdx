...
In this class we extend our script such that it prompts the user for a project name. The script then creates a folder for the new project on your hard-drive (and also some subfolders) and saves the project in that folder.
