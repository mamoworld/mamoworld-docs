...
<ToolTeaserBox src="/img/overview/toolTeaserInsertFrames.png" link="/tools-ae/compTimeTools#insertFramesAtCurrentTime" title="Comp Time Tools" description="Insert frames - in the middle of a comp, for example. This tool will shift layers, keyframes and markers as needed and change the duration of a comp & precomps."/>
