...
<Anigif src={useBaseUrl('/img/tutorials-pr/firstSteps/step_9.gif')} />
 ...
 In the *Open Folder* dialog, you can even preselect a folder. These are the little details that can save you so much time and allow you to focus on the creative part of your work!
