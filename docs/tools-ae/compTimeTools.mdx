...
- changes the duration and start time code of the active comp
- shifts all layers in time as needed
- if a precomp starts at the beginning of the comp, also extra frames are inserted at the beginning of the precomp to make sure it still starts at the beginning of the comp after the duration change.
