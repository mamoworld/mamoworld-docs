...
If you enable the mirror option, the tool creates a symmetric set of guides. If you enter a position of 100px, for example, it will create both a guide 100px away from the left (and/or top) and the right (and/or bottom) edge of the comp.
