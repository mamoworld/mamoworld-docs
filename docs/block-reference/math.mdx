...
This example asks the user to enter a number. Then the script makes sure that the resulting number is between 0 and 100. If the user enters something bigger than 100, for example, the result will still be 100 and if the user enters a negative number, the result will be 0.
