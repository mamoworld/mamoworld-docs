...
By default (bin `\`) this block iterates over all project items in the root bin of the active project. For all the ways to specify a particular bin, see [Accessing a Particular Project Item](prProjectItems.mdx#accessProjectItem).
...
By default (bin `\`) this block puts all project items in the root bin of the active project in the list. For all the ways to specify a particular bin, see [Accessing a Particular Project Item](prProjectItems.mdx#accessProjectItem).
