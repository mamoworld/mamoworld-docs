...
For each argument, the function block creates a [variable](variables.mdx) and when the function is executed, the variable will have the value that you gave as an argument to the function call.
...
code block of the function definition is
empty. But if the calculation of the
random number required any
preparational steps, you could plug
these into the function definition.
