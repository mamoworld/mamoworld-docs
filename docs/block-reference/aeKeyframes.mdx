...
- **adjust new keys to keys before** combined with
...
If the newly inserted keyframes should animate a layer into the scene, you rather want to ignore keys before the animate in and want to make sure that the animation ends where the layer currently is. In that situation, you best set *"adjustment before"* to *"none"*  and *"adjustment after"* to *"adjust new keys to keys after"*.
