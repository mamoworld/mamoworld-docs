...
This block sets one of the properties of the sequence. For a detailed description of properties, see the [Get Property of Sequence block](prSequence#pr_sequence_get_property) or for time-related properties [Get Time Value of Sequence](prSequence#pr_sequence_get_time).
