...
The optional frame rate parameter is used to convert between values given in frames and other values. If neither the source nor the target format is frames, the frame rate is ignored.
If you want to use the frame rate of a composition, footage item or layer, you can simply pass this object as frame rate parameter.
If you don't specify a frame rate parameter, the frame rate of the active composition is used.
