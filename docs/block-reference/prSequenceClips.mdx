...
By default, this block iterates over the clips of the active sequence. For all possible ways to specify a sequence see [Accessing a Particular Sequence](prSequence#accessSequence).
...
Returns one of the following properties of the given sequence clip (for all the ways you can specify a clip, see [Accessing a Particular Sequence Clip](prSequenceClips#accessSequenceClip))
...
Sets any property of the given sequence clip (for all the ways you can specify a clip, see [Accessing a Particular Sequence Clip](prSequenceClips#accessSequenceClip))
